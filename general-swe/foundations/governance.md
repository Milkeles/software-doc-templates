...
**Most projects do not need this document yet.** Minimum Viable Governance names the trigger: a corporate home becomes necessary "typically when your organization begins holding money". Before that, a maintainers list and a contributing guide carry the load. Writing elaborate governance for a three-person project is a way of avoiding the work.

**Start from Minimum Viable Governance, not from a large project's file.** GitHub's MVG template is six sections and fits on a page: roles, decisions, how we work, no confidentiality, trademarks, amendments. It is CC-BY licensed. Copying Kubernetes' or Python's governance into a small project imports machinery you cannot staff.

**Define what consensus means.** MVG's wording is the clearest: "While explicit agreement of all Maintainers is preferred, it is not required for consensus. Rather, the Maintainers will determine consensus based on their good faith consideration of a number of factors, including the dominant view of the Contributors and nature of support and objections." Without a definition, "we work by consensus" means whatever the loudest person says it means.

**If one person currently decides everything, this document's real job is succession.** The BDFL model runs fine until the BDFL leaves; replacing Python's took roughly six months of formal process. Write down what happens when they stop.

**Grant powers together with instructions to use them rarely.** PEP 13: "The council should look for ways to use these powers as little as possible. Instead of voting, it's better to seek consensus." Node.js says the same operationally — the TSC agenda "is not to review or approve all patches".
